...
int a=0,i=0;
    ...
    do
{
    printf("\n  ::::::::::::::::::::::::::  ONE-OFF MANAGEMENT SYSTEM !!! LOGIN PORTAL !!! ::::::::::::::::::::::::::  ");
    printf(" \n                       ENTER USERNAME:-");
scanf("%s", &uname);
printf(" \n                       ENTER PASSWORD:-");
while(i<10)
...
{
printf("  \n\n\n       WELCOME TO ONE-OFF MANAGEMENT SYSTEM  !!!! LOGIN IS SUCCESSFUL");
    printf("\n LOADING PLEASE WAIT... \n");
    for(i=0; i<3; i++)
    {
        printf(".");
...
printf("1> Add Employee's Record"); /// option for add record
        gotoxy(30,07);
        printf("2> List of  Employee's Records"); /// option for showing existing record
        gotoxy(30,9);
